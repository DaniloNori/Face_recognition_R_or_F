...
# Importing the required classes from tkinter.ttk module
...
while True:
    ...
    if len(detections) > 0:
        ...
        if confidence > args["confidence"]:
            ...
            saved += 1
            filename = os.path.join(args["output"], f"face_{saved}.jpg")
            cv2.imwrite(filename, face)

print("[INFO] saved {} face(s) to {}".format(saved, args["output"]))
vs.release()
